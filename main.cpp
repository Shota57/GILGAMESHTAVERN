...
int main() {
	...
	std::cout << "==============================================================================" << std::endl;
	std::cout << " _______  ___   ___      _______  _______  __   __  _______  _______  __   __ " << std::endl;
	std::cout << "|       ||   | |   |    |       ||   _   ||  |_|  ||       ||       ||  | |  |" << std::endl;
	std::cout << "|    ___||   | |   |    |    ___||  |_|  ||       ||    ___||  _____||  |_|  |" << std::endl;
	std::cout << "|   | __ |   | |   |    |   | __ |       ||       ||   |___ | |_____ |       |" << std::endl;
	std::cout << "|   ||  ||   | |   |___ |   ||  ||       ||       ||    ___||_____  ||       |" << std::endl;
	std::cout << "|   |_| ||   | |       ||   |_| ||   _   || ||_|| ||   |___  _____| ||   _   |" << std::endl;
	std::cout << "|_______||___| |_______||_______||__| |__||_|   |_||_______||_______||__| |__|" << std::endl;
	std::cout << "             _______  _______  __   __  _______  ______    __    _            " << std::endl;
	std::cout << "            |       ||   _   ||  | |  ||       ||    _ |  |  |  | |           " << std::endl;
	std::cout << "            |_     _||  |_|  ||  |_|  ||    ___||   | ||  |   |_| |           " << std::endl;
	std::cout << "              |   |  |       ||       ||   |___ |   |_||_ |       |           " << std::endl;
	std::cout << "              |   |  |       ||       ||    ___||    __  ||  _    |           " << std::endl;
	std::cout << "              |   |  |   _   | |     | |   |___ |   |  | || | |   |           " << std::endl;
	std::cout << "              |___|  |__| |__|  |___|  |_______||___|  |_||_|  |__|           " << std::endl;
	std::cout << "                                                                              " << std::endl;
	std::cout << "==============================================================================" << std::endl;
	std::cout << "                    ～ G I L G A M E S H ’ S   T A V E R N ～              　" << std::endl;
	std::cout << "==============================================================================" << std::endl;
